...
export default function RegisterPage() {
  ...
  // gender: string;
    ...
    try {
      ...
      router.push(`/auth/otp-step?email=${encodeURIComponent(data.email)}`);
    } catch (err: any) {
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  <input
                    {...register("firstName")}
                    className={`text-black w-full pl-4 pr-11 py-3.5 bg-slate-50 border ${errors.firstName ? "border-red-300" : "border-slate-200"} rounded-2xl focus:bg-white focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none transition-all duration-200`}
                    placeholder="John"
                  />
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  <input
                    {...register("lastName")}
                    className={`text-black w-full pl-4 pr-11 py-3.5 bg-slate-50 border ${errors.lastName ? "border-red-300" : "border-slate-200"} rounded-2xl focus:bg-white focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none transition-all duration-200`}
                    placeholder="Doe"
                  />
                  <User className="absolute right-4 top-3.5 text-slate-400 w-5 h-5 group-focus-within:text-indigo-500" />
                </div>
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="text-black w-full px-4 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl focus:bg-white focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none"
              />
              {errors.dateOfBirth && (
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                <input
                  {...register("email")}
                  type="email"
                  className={`text-black w-full pl-4 pr-11 py-3.5 bg-slate-50 border ${errors.email ? "border-red-300" : "border-slate-200"} rounded-2xl focus:bg-white focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none transition-all duration-200`}
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                <input
                  ...
                  className={`text-black w-full pl-4 pr-11 py-3.5 bg-slate-50 border ${errors.password ? "border-red-300" : "border-slate-200"} rounded-2xl focus:bg-white focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none transition-all duration-200`}
                  placeholder="••••••••"
                />
                <button
                  type="button"
          ...
          <div className="w-full max-w-md aspect-square bg-indigo-600 rounded-[3rem] rotate-3 flex items-center justify-center relative shadow-2xl">
            ...
            <div className="relative z-10 text-white p-10">
              ...
              <p className="text-indigo-100">
                The best way to manage your tasks, collaboration, and progress
